...
这一步会从官方仓库克隆 find-skills，创建完整的包结构，安装到 `C:\Users\你的用户名\.agents\skills\find-skills\`。

**步骤 2：替换为 Windows 兼容版本的 SKILL.md**
...
**为什么要替换？**
- 原版使用 Bash 运行命令，在 Windows 上会返回空白
- Windows 兼容版使用 PowerShell，解决了这个问题

**步骤 3：重启 Claude Code**

关闭并重新打开 Claude Code，让它读取更新后的 skill。
...
- Windows 兼容版本：https://github.com/spsz831/find-skills-windows
